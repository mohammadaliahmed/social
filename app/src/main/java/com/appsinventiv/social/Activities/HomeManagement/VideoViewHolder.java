...
//        extends RecyclerView.ViewHolder implements ToroPlayer, CacheListener {
...
//    }
//
//    public void bind(PostModel videoDictionary, int position) {
//
////        String url = videoDictionary.getProxyUrl();
////        String url = videoDictionary.getVideoUrl();
//        imageUrl = AppConfig.BASE_URL_Image + videoDictionary.getVideo_image_url();
//        String url = videoDictionary.getProxyUrl();
//
////        String url = AppConfig.BASE_URL_Videos + videoDictionary.getVideoUrl();
//
//
//        // video cache

...
public class MyFriendsListAdapter extends RecyclerView.Adapter<MyFriendsListAdapter.ViewHolder> {
    ...
    public MyFriendsListAdapter(Context context, List<UserModel> itemList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MyFriendsListAdapter.ViewHolder viewHolder = new MyFriendsListAdapter.ViewHolder(view);
        return viewHolder;
    }
